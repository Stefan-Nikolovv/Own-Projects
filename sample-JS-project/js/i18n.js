...
export const translations = {
  en: {
    ...
    connection_offline_title: "You're offline",
    connection_offline_text: "The last schedule is available in read-only mode.",
    connection_online_title: "Back online",
    connection_online_text: "The schedule is being refreshed.",
    offline_schedule_snapshot: "Showing the last saved schedule. Booking is unavailable offline.",
    offline_read_only: "The schedule is read-only while you are offline.",
    offline_action: "Connect to the internet to complete this action.",
    ...
    ticket_title: "Your training ticket",
    ticket_hint: "Keep this ticket for quick access to your booking.",
    ticket_training: "Training",
    ticket_recurring: "Includes {count} weekly sessions",
    share_ticket: "Share",
    ticket_share_text: "Emotion in Motion training on {date} at {time}. Ticket {reference}.",
    ticket_copied: "Ticket details copied.",
    ticket_share_failed: "The ticket could not be shared.",
    ticket_checkin_eyebrow: "Ticket check-in",
    ticket_checkin_title: "Training attendance",
    ticket_checkin_loading: "Checking this ticket...",
    ticket_checkin_invalid: "This ticket is invalid or no longer exists.",
    ticket_checkin_admin: "Log in as admin to check in this ticket.",
    ticket_checkin_saved: "Attendance updated successfully.",
    ...
    remember_details: "Remember details on this device",
    clear_remembered_details: "Clear remembered details",
    remembered_details_cleared: "Remembered details were cleared.",
    ...
    slot_roster_eyebrow: "Session participants",
    slot_roster_title: "Session roster",
    slot_roster_trigger: "Booked: {count}",
    slot_roster_count: "{count} booked",
    slot_roster_capacity: "{count} spots left",
    slot_roster_search_label: "Find a participant",
    slot_roster_search_placeholder: "Name or phone",
    slot_roster_no_results: "No participants match this search.",
  ...
  bg: {
    ...
    connection_offline_title: "Няма интернет връзка",
    connection_offline_text: "Последният график е достъпен само за преглед.",
    connection_online_title: "Отново си онлайн",
    connection_online_text: "Графикът се обновява.",
    offline_schedule_snapshot: "Показваме последния запазен график. Записването не е достъпно офлайн.",
    offline_read_only: "Графикът е само за преглед, докато няма интернет.",
    offline_action: "Свържи се с интернет, за да завършиш това действие.",
    ...
    close: "Затвори",
    ticket_confirmed: "Записването е потвърдено",
    ticket_title: "Твоят билет за тренировка",
    ticket_hint: "Запази билета за бърз достъп до записването.",
    ticket_training: "Тренировка",
    ticket_recurring: "Включва {count} седмични тренировки",
    share_ticket: "Сподели",
    ticket_share_text: "Тренировка в Emotion in Motion на {date} от {time}. Билет {reference}.",
    ticket_copied: "Данните за билета са копирани.",
    ticket_share_failed: "Билетът не можа да бъде споделен.",
    ticket_checkin_eyebrow: "Проверка на билет",
    ticket_checkin_title: "Присъствие на тренировка",
    ticket_checkin_loading: "Проверка на билета...",
    ticket_checkin_invalid: "Билетът е невалиден или вече не съществува.",
    ticket_checkin_admin: "Влез като администратор, за да провериш билета.",
    ticket_checkin_saved: "Присъствието е обновено успешно.",
    ...
    remember_details: "Запомни данните на това устройство",
    clear_remembered_details: "Изчисти запомнените данни",
    remembered_details_cleared: "Запомнените данни бяха изчистени.",
    dialog_saved_names: "Записани имена",
    dialog_save: "Запази място",
    dialog_saving: "Запазване...",
    dialog_updating: "Обновяване...",
    dialog_update: "Обнови записването",
    dialog_cancel_edit: "Откажи редакцията",
    dialog_no_names: "Все още няма записани имена.",
    slot_roster_eyebrow: "Участници в тренировката",
    slot_roster_title: "Списък за часа",
    slot_roster_trigger: "Записани: {count}",
    slot_roster_count: "{count} записани",
    slot_roster_capacity: "{count} свободни места",
    slot_roster_search_label: "Намери участник",
    slot_roster_search_placeholder: "Име или телефон",
    slot_roster_no_results: "Няма участници, които отговарят на търсенето.",
